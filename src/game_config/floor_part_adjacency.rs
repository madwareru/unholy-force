...
pub struct FloorPartAdjacencyConfig {
    ...
    pub north_adjacent_parts: HashSet<ConfigId<FloorPartConfig>>,
    pub west_adjacent_parts: HashSet<ConfigId<FloorPartConfig>>,
    pub south_adjacent_parts: HashSet<ConfigId<FloorPartConfig>>,
    pub east_adjacent_parts: HashSet<ConfigId<FloorPartConfig>>,
}
